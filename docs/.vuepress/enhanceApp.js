function integrateGitment(router) {
  ...
  function renderGitment() {
    const gitment = new Gitment({
      ...
      owner: 'berlinen', // 必须是你自己的github账号
      repo: 'departBlog', // 上一个准备的github仓库
      link: location.origin + location.pathname,
      oauth: {
        client_id: '74950a0af874ae59e2fb', // 第一步注册 OAuth application 后获取到的 Client ID
        client_secret: '890ecf4b46af5343af4453d75eaa9009de59f5f7', // 第一步注册 OAuth application 后获取到的 Clien Secret
      },
    })
